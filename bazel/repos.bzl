...
# https://github.com/3rdparty/bazel-rules-tclap repository. If you
...
# different version of bazel-rules-tclap follow the Bazel build
# instructions at https://github.com/3rdparty/bazel-rules-tclap.
########################################################################
...
def repos(external = True, repo_mapping = {}):
    ...
    if external:
        maybe(
            ...
            commit = "3e22a8af7c25aef6d09c6d94c3d69f54855c8293",
